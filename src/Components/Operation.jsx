...
const Operation = () => {
  ...
  const Decrement = () => {
    count <= 0
      ? toast.warn("Number can't go below Zero", {
          position: "top-center",
          autoClose: 5000,
    ...
    <div className="bg-gray-900 min-h-screen ">
      <div className="flex flex-col items-center justify-center w-full h-screen relative   ">
        <div className="bg-gray-900 rounded-3xl z-10 shadow-lg md:w-[40vw] max-w-lg w-full ">
          <p className="text-teal-600 text-2xl text-center font-semibold">
        ...
        <div className="bg-white z-20 rounded-3xl shadow-lg md:w-[40vw] md:h-[40vh] max-w-lg w-full ">
          <div className="flex items-center justify-center pt-6">
            <button className="border border-slate-500 rounded-lg px-6 py-2 h-15 w-35 text-lg font-semibold shadow-sm text-white bg-[#064E3B]">
              {count}
            </button>
          </div>
          ...
          <div className="flex md:flex-row flex-col justify-evenly items-center gap-4 ">
            <button
              ...
              className=" border border-slate-500 rounded-lg px-6 py-4 shadow-sm w-full md:h-20 md:w-40 text-white bg-[#de6a12]"
            >
              INCREMENT
            </button>
            <button
              onClick={() => Decrement()}
              className=" border border-slate-500 rounded-lg px-6 py-4 shadow-sm  w-full md:h-20 md:w-40 text-white bg-[#1E3A8A]"
            >
              DECREMENT
            </button>
          </div>
